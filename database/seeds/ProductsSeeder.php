...
class ProductsSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('products')->insert([
            ...
            'productDesc' => 'Cơm thịt ba chỉ rang cháy cạnh của Ship đồ ăn đêm Hà Nội là một trong những món cực dễ ăn và đưa cơm. Món ăn này thưởng thức cùng dưa muối chua giữa mùa hè thì thật tuyệt vời hoặc ăn giữa tiết trời se … ',
            'productPrice' => '55.000',
            'categoryId' => 'Cơm',
        ...
        DB::table('products')->insert([
            ...
            'productDesc' => 'Với một chiếc đùi gà, có vô vàn món và cách chế biến khác nhau. Nhưng hôm nay, Ship đồ ăn đêm Hà Nội xin giới thiệu đến quý khách món ăn mang một hương vị hoàn toàn khác chỉ sử dụng đùi gà chiên vàng, cộng với … ',
            'productPrice' => '60.000',
            'categoryId' => 'Cơm',
            'img' => 'http://shipdoan.vn/uploads/2014/08/Cơm-dui-ga-sot-bbq-300x166.jpg',
            'status' => '1',
        ]);

        DB::table('products')->insert([
            'productName' => 'Cơm sườn sốt me',
            'productDesc' => 'Cơm sườn sốt me đang đã chinh phục hàng trăm thực khách của Ship đồ ăn đêm Hà Nội, liệu bạn muốn có cơ hội thưởng thức món ăn tuyệt ngon này? Đừng bỏ lỡ cuộc gọi đến số 0988 380 600 để được phục vụ món … ',
            'productPrice' => '60.000',
            'categoryId' => 'Cơm',
        ...
        DB::table('products')->insert([
            ...
            'productPrice' => '60.000',
            'categoryId' => 'Cơm',
            'img' => 'http://shipdoan.vn/uploads/2014/08/Cơm-bo-sot-tieu-den-300x166.jpg',
            'status' => '1',
        ]);
        ...
        DB::table('products')->insert([
            ...
            'productDesc' => 'Thêm cơm gà sốt me của Ship đồ ăn đêm Hà Nội vào danh sách các món ăn ngon sẽ không bao giờ khiến bạn hối hận. Bát cơm trắng dẻo thơm sẽ hết vèo dù là giữa trưa hè nắng gắt bởi vị chua ngọt đậm … ',
            'productPrice' => '60.000',
            'categoryId' => 'Cơm',
        ...
        DB::table('products')->insert([
            ...
            'productDesc' => 'Cơm rang thập cẩm, một món ăn hấp dẫn và cùng quen thuộc với khách hàng của Ship đồ ăn đêm Hà Nội. Đây không chỉ là bữa ăn trưa đủ chất, không những thế cơm rang thập cẩm cũng là một món ăn đêm lí tưởng , … ',
            'productPrice' => '45.000',
            'categoryId' => 'Cơm',
        ...
        DB::table('products')->insert([
            ...
            'productDesc' => 'Cơm đùi gà Singapore chỉ cần nhìn thôi đã thấy ngon mắt rồi. Theo đầu bếp của Ship đồ ăn đêm Hà Nội, Đùi ga rán vàng với cơm được chế biến từ hai loại gạo Thái và Nhật. Phương pháp chế biến cũng cầu kì, theo … ',
            'productPrice' => '60.000',
            'categoryId' => 'Cơm',
        ...
        DB::table('products')->insert([
            ...
            'productDesc' => 'Với một suất cơm đùi gà xào xả ớt của Ship đồ ăn đêm Hà Nội là bạn đã có thể ngất ngây cái bụng vì cả chất và lượng của suất ăn. Chỉ cần nghĩ đến từng miếng thịt gà thơm lừng mùi sả và vị … ',
            'productPrice' => '55.000',
            'categoryId' => 'Cơm',
        ...
        DB::table('products')->insert([
            ...
            'productDesc' => 'Cơm đùi gà nướng mật ong của Ship đồ ăn đêm Hà Nội luôn hấp dẫn người ăn không chỉ bởi màu vàng nâu cực hấp dẫn của da gà mà ngay cả khứu giác của bạn cũng bị chinh phục với hương thơm ngọt ngào của … ',
            'productPrice' => '55.000',
            'categoryId' => 'Cơm',
        ...
        DB::table('products')->insert([
            ...
            'productDesc' => 'Món ăn của Ship đồ ăn đêm Hà Nội luôn cung cấp đầy đủ chất dinh dưỡng. Khi bạn ngán cơm thì sao không nếm thử món phở xào gà rau củ cực hấp dẫn nhỉ? Từng miếng thịt gà xé cùng với rau củ xào thơm … ',
            'productPrice' => '50.000',
            'categoryId' => 'Mì',
        ...
        DB::table('products')->insert([
            ...
            'productDesc' => 'Chắc hẳn đã nhiều lần bạn được thưởng thức món mỳ xào bò, Nhưng cũng với món mỳ này tại Ship đồ ăn đêm Hà Nội, đầu bếp đã khéo léo kết hợp đầy đủ các nguyên liệu và gia vị để tạo nên món mỳ này … ',
            'productPrice' => '50.000',
            'categoryId' => 'Mì',
        ...
        DB::table('products')->insert([
            ...
            'productDesc' => 'Phở xào bò đặc biệt thơm ngon và hấp dẫn của Ship đồ ăn đêm Hà Nội. Chỉ cần một suất thôi là đảm bảo bạn no căng bụng luôn. Đầu bếp đã khéo léo kết hợp giữa các nguyên liệu và gia vị để món Phở … ',
            'productPrice' => '50.000',
            'categoryId' => 'Mì',
        ...
        DB::table('products')->insert([
            ...
            'productDesc' => 'Nem chua rán – Món ăn vặt đã rất quen thuộc với rất nhiều bạn trẻ. Với cách chiên đặc biệt của đâug bếp Ship đồ ăn đêm Hà Nội – Mìếng nem chiên cắn dòn tan, hòa quyện cùng tường ớt cay cay làm dậy lên … ',
            'productPrice' => '50.000',
            'categoryId' => 'Mì',
        ...
        DB::table('products')->insert([
            'productName' => 'Pepsi',
            'productDesc' => 'Đã khát cùng Pepsi lon ướp lạnh chỉ 15k của Ship đồ ăn đêm Hà Nội. ',
            'productPrice' => '15.000',
            'categoryId' => 'Đồ uống',
        ...
        DB::table('products')->insert([
            ...
            'productDesc' => 'Nước tăng lực Sting dâu ướp lạnh giá chỉ 15k tại Ship đồ ăn đêm Hà Nội. Uống sting – thỏa sức tung hoành xuyên màn đêm ',
            'productPrice' => '15.000',
            'categoryId' => 'Đồ uống',
        ...
        DB::table('products')->insert([
            ...
            'productDesc' => 'Những lon bia hà nội mát lạnh đng chờ bạn thưởng thức cùng đồ ăn tuyệt ngon tại Ship đồ ăn đêm Hà Nội. Gọi món ngay ',
        ...
        DB::table('products')->insert([
            ...
            'productDesc' => 'Đơn giản và dân dã nhưng món cơm rang trứng lại được rất nhiều người yêu thích và dùng như một bữa chính trong ngày. Với những đơn hàng liên tiếp đặt món ăn này, Ship đồ ăn đêm Hà Nội thì niềm tin của chúng tôi … ',
            'productPrice' => '30.000',
            'categoryId' => 'Gọi thêm',
        ...
        DB::table('products')->insert([
            ...
            'productDesc' => 'Nhiều người đã quen thuộc với món gà chiên nhưng lại rất ít người đã từng có cơ hội thưởng thức món gà rang muối. Đặc biệt với cách làm muối rang trứ danh của Ship đồ ăn đêm Hà Nội thì nhiều thực khách đã mê … ',
            'productPrice' => '45.000',
            'categoryId' => 'Gọi thêm',
        ...
        DB::table('products')->insert([
            ...
            'productDesc' => 'Đùi gà sốt me sẽ là một lựa chọn cực thích hợp trong thời tiết oi nóng của ngày hè. Ship đồ ăn đêm Hà Nội sẽ mang đến cho bạn một phong vị hoàn toàn mới cực hấp dẫn bằng vị chua dịu, cay ngọt của … ',
            'productPrice' => '50.000',
            'categoryId' => 'Gọi thêm',
        ...
        DB::table('products')->insert([
            ...
            'productDesc' => 'Sườn xào chua ngọt là món ăn kèm được rất nhiều thực khách ưa chuộng. Từ những nguyên liệu đặc biệt, đầu bếp của Ship đồ ăn đêm Hà Nội đã khéo léo kết hợp để tạo nên hương vị đặc biệt cho món ăn. Chính vì … ',
            'productPrice' => '50.000',
            'categoryId' => 'Gọi thêm',
        ...
        DB::table('products')->insert([
            ...
            'productDesc' => 'Đùi gà chiên Singapore đặc biệt của Ship đồ ăn đêm Hà Nội. Chắc hẳn bạn đã từng thưởng thức rất nhiều những món ăn được chế biến từ đùi gà, nhưng bạn đã được thưởng thức món ăn chế biến từ gà mang hương vị Singapore … ',
            'productPrice' => '50.000',
            'categoryId' => 'Gọi thêm',
        ...
        DB::table('products')->insert([
            ...
            'productDesc' => 'Đùi gà sốt chua ngọt là một trong những món được nhiều người ưa thích nhất của Ship đồ ăn đêm Hà Nội. Và bạn chắc chắn sẽ yêu thích món ăn này khi đã một lần nếm thử. Đùi gà sốt chua ngọt- Ship đồ ăn … ',
            'productPrice' => '50.000',
            'categoryId' => 'Gọi thêm',
        ...
        DB::table('products')->insert([
            ...
            'productDesc' => 'Vị thơm ngọt của rượu vang quyện trong nước sốt của món bò lúc lắc của Ship đồ ăn đêm Hà Nội khiến người ăn khó mà quên được khi đã từng thưởng thức. Chỉ có chế biến từ nguyên liệu thịt tươi mới có thể tạo … ',
            'productPrice' => '50.000',
            'categoryId' => 'Gọi thêm',
        ...
        DB::table('products')->insert([
            ...
            'productDesc' => 'Đùi gà chiên xù – Món ăn nhanh đã hấp dẫn rất nhiều thực khách của Ship đồ ăn đêm Hà Nội. Những chiếc đùi gà tươi được đầu bếp tẩm ướp kỹ càng, chiên vàng trong dầu mang lại hương vị hấp dẫn không thể chối … ',
            'productPrice' => '50.000',
            'categoryId' => 'Gọi thêm',
        ...
        DB::table('products')->insert([
            ...
            'productDesc' => 'Bạn đã bao giờ được thưởng thức món Đùi gà sốt BBQ với nước sốt đặc biệt mà chỉ cần thưởng thức một lần là không bao giờ quên chưa ? Đầu bếp của Ship đồ ăn đêm Hà Nội đã đặc biệt khéo léo đã kết … ',
            'productPrice' => '50.000',
            'categoryId' => 'Gọi thêm',
        ...
        DB::table('products')->insert([
            ...
            'productDesc' => 'Món sườn sốt me có vị chua ngọt thanh dịu thấm đượm vào từng miếng sườn vàng ươm thơm ngậy của Ship đồ ăn đêm Hà Nội sẽ khiến bạn khó chối từ. Đây chính là món ăn cực hấp dẫn không hề bị ngán trong những … ',
            'productPrice' => '50.000',
            'categoryId' => 'Gọi thêm',
        ...
        DB::table('products')->insert([
            ...
            'productDesc' => 'Cơm rang kim chi – Món ăn mang phong cách mới lạ đến từ Hàn Quốc. Với biến tấu một chút của Ship đồ ăn đêm Hà Nội, các bạn sẽ được thưởng thức món ăn Cơm rang tuyệt ngon mang cả hai phong cách Việt Nam … ',
            'productPrice' => '55.000',
            'categoryId' => 'Hàn Quốc',
        ...
        DB::table('products')->insert([
            ...
            'productDesc' => 'Món Sườn nướng kiểu Hàn Quốc hấp dẫn. Đầu bếp của Ship đồ ăn đêm Hà Nội đã khéo léo kết hợp những gia vị đặc biệt tạo nên hương vị đặc biệt hấp dẫn cho món ăn mang hương vị Hàn Quốc này. Thử tưởng tượng … ',
            'productPrice' => '50.000',
            'categoryId' => 'Hàn Quốc',
