            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <li class="active treeview">
                    ...
                    <ul class="treeview-menu">
                        <li class="active"><a href="/admin/listproducts"><i class="fa fa-circle-o"></i> Product list</a></li>
                        <li><a href="/admin/addProduct"><i class="fa fa-circle-o"></i> Add product</a></li>
                        <li><a href="/admin/listcategories"><i class="fa fa-circle-o"></i> Category</a></li>
                    </ul>
                </li>
                <li class="treeview">
                    <a href="#">
